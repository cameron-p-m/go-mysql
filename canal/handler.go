...
type EventHandler interface {
	...
	OnGTID(header *replication.EventHeader, gtid mysql.GTIDSet, gtidEvent *replication.GTIDEvent) error
...
func (h *DummyEventHandler) OnGTID(*replication.EventHeader, mysql.GTIDSet, *replication.GTIDEvent) error {
	return nil
}
